            ...
            if (emailList && emailList.length > 0) {
                ...
                emailList.forEach(async (email) => {
                    try {
                        ...
                        await this.databaseService.updateDocument(this.appName, this.databaseName, this.EmailMessage, email.$id, { errorReason: error.message, attemptCount: email.attemptCount + 1 });
                    }
                })
            }
        })
