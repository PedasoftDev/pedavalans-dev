...
import { DatePicker, LocalizationProvider, trTR as DateTR, DateTimePicker } from "@mui/x-date-pickers";
                                        ...
                                        </LeftContainer>
                                        {
                                            ...
                                            <RightContainer>
                                                ...
                                                <div style={{
                                                    ...
                                                    <StyledDataGrid
                                                        columns={columns}
                                                        rows={selectedCompetencyList.filter((competency) => selectedGroupId === "" ? true : competency.competency_group_id === selectedGroupId)}
